"""Evaluate supervised prompt mixer on GSM8K test set."""
...
def main():
    ...
    parser.add_argument("--output", type=str, default="results/experiment1/supervised_results.json")
    ...
    result = evaluate(model, mode="supervised", batch_size=args.batch_size,
                      max_samples=args.max_samples)
    print(f"\nSupervised accuracy: {result['accuracy']:.4f} ({result['correct']}/{result['total']})")
